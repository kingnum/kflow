...
Define the bug registration mechanism — `bugs/` directory structure, `index.md` format, paginated detail file format (≤20 bugs per file), severity grading, and status tracking for issue lifecycle management.
