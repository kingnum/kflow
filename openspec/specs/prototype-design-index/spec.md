...
定义 prototype/index.md 的内容规格——原型产物清单（Prototype Manifest），供下游阶段消费。包含产物组织方式、原型文件清单（含角色标注）、页面清单、设计系统引用、共享资源清单和修订记录。
...
prototype/index.md SHALL 包含共享资源清单（如存在）。
